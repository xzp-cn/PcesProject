        ...
        if (cobj.objname == "shou")
        {
            ...
            teacherAnim.timePointEvent = (t) =>
            {
                if (t >= start && t <= end)
                {
                    teacherAnim.timePointEvent = null;
                    xiaohuaAnim.OnContinue();
                    oldPos = RndReinforcementB.transform.localPosition;
            ...
            teacherAnim.timePointEvent = (t) =>
            {
                ...
                if (t >= 94 && t <= 96 && !passB)
                {
                    ...
                    swapui.speakEvent = () =>
                    {
                        ...
                        RndReinforcementB.transform.localPosition = oldPos;
